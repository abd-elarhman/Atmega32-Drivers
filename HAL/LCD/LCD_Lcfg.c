...
{
    {
         ...
         * 
         * Uncomment the desired configuration by removing the block comment.
         * 
         * Example 1: 8-bit mode with 2 lines and 5x7 dots
         
           .LCD_Mode=LCD_8BIT_MODE,
           .LCD_LINE=LCD_2lineMode,
           .LCD_DOTS=LCD_5x7Dots,
           .LCD_RS_Pin=PB0,
           .LCD_EN_Pin=PB1,
           .LCD_pins={PC0,PC1,PC2,PC3,PC4,PC5,PC6,PC7}
           
         * Example 2: 4-bit mode with 2 lines and 5x7 dots
